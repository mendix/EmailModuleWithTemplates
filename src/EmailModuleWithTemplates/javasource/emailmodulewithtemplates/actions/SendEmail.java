...
import emailmodulewithtemplates.mail.EmailModule;
import emailmodulewithtemplates.mail.SMTPConfiguration;
import emailmodulewithtemplates.proxies.Header;
...
public class SendEmail extends CustomJavaAction<java.lang.Boolean>
{
	...
	private java.util.List<emailmodulewithtemplates.proxies.Header> HeaderList;
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		this.HeaderList = new java.util.ArrayList<emailmodulewithtemplates.proxies.Header>();
		if (__HeaderList != null)
			for (IMendixObject __HeaderListElement : __HeaderList)
				this.HeaderList.add(emailmodulewithtemplates.proxies.Header.initialize(getContext(), __HeaderListElement));
		...
		String separator = (String) emailmodulewithtemplates.proxies.constants.Constants.getEmailAddressSeparator();
		if (separator == null)
			separator = ",";
		...
		if(emailmodulewithtemplates.proxies.constants.Constants.getSendingEnabled()) {		
